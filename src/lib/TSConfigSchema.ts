// Auto-generated from https://json.schemastore.org/tsconfig.json
 ...
 */
export type TsNodeModuleTypes = Record<string, unknown> | null;
...
export type TSConfigData = JSONSchemaForTheTypeScriptCompilerSConfigurationFile;
